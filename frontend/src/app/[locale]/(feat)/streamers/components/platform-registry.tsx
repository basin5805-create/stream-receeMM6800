...
const XiaohongshuPlatformForm = lazy(() =>
	import("@/src/app/[locale]/(feat)/streamers/components/platforms/xiaohongshu-platform").then(mod => ({
		default: mod.XiaohongshuPlatformForm,
	}))
)
...
export const platformRegistry: Record<string, PlatformRegistryItem> = {
	...
	[PlatformType.XIAOHONGSHU]: {
		component: XiaohongshuPlatformForm,
		getProps: props => ({
			strings: props.strings.xiaohongshu,
			allowNone: props.allowNone,
		}),
	},
}
