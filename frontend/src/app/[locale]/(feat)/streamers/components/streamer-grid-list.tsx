...
export function StreamerGridList({ recordingString, inactiveString }: StreamerWrapperProps) {
	return (
		<div className='grid grid-cols-1 gap-4 lg:grid-cols-2 lg:space-x-8'>
			...
			<div className='col-span-1 space-y-4'>
				<Suspense fallback={<RecordListSkeleton title={inactiveString} />}>
					<ServerRecordList filter={["offline", "inactive"]} title={inactiveString} />
				</Suspense>
			</div>
		</div>
	)
