...
import { xiaohongshuRegex } from "@/src/lib/data/platform/xiaohongshu/constants"
...
export const streamerSchema = z.object({
	...
	url: z
		...
		.refine(
			url => {
				const regexps = [huyaRegex, douyinRegex, douyuRegex, twitchRegex, pandatvRegex, weiboRegex, xiaohongshuRegex]
